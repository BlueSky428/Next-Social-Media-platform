...
const UserInfomation: FC = () => {
    ...
    return (
        <div className="mx-auto max-w-screen-xl lg:px-4 md:px-4 sm:px-0 px-0 w-full flex items-center lg:mt-16 md:mt-14 sm:mt-20 mt-28 relative">
            <div className="flex flex-col">
                <div className="flex items-center">
                    <div className="flex justify-center items-center lg:w-32 lg:h-32 md:w-28 md:h-28 sm:w-20 sm:h-20 w-14 h-14 relative">
                        ...
                        <div className="absolute bottom-0 right-0 h-8 w-8 flex justify-center items-center rounded-full bg-[#581c87]">
                    ...
                    <div className="flex justify-center flex-col lg:px-4 md:px-4 sm:px-2 px-2 py-2">
                        <div className="flex items-center">
                            ...
                            <div className="flex justify-center items-center px-1 ml-4 rounded" style={{ "color": "#fff", "backgroundColor": "#581c87" }}>
                ...
                <div className="flex flex-col justify-center lg:w-[30%] md:w-full lg:absolute lg:top-4 lg:right-0 lg:mt-0 md:mt-4 sm:mt-4 mt-4">
                    <div className="lg:w-full md:w-[45%] sm:w-[60%] gap-2 flex items-center justify-between lg:px-0 md:px-4 sm:px-4 px-4">
                        <div className="lg:w-[45%] md:w-[50%] sm:w-1/2 w-1/2 border flex justify-center items-center py-2 cursor-pointer rounded-lg">More about me</div>
                        <div className="lg:w-[45%] md:w-1/2 sm:w-1/2 w-1/2 border flex justify-center items-center py-2 cursor-pointer rounded-lg">
                    ...
                    <div className="lg:w-full md:w-[45%] sm:w-[60%] flex-col items-center justify-center mt-6 rounded-lg shadow-lg lg:flex">
                        ...
                        <div className="lg:w-full md:w-full sm:w-full w-full flex justify-center px-4">
                            <button type="button" className="w-full bg-[#581c87] py-2 text-white rounded hover:opacity-80 transition duration-300">Contact me</button>
                        </div>
