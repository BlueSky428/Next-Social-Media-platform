                ...
                <div className="mb-16 lg:mt-32 xl:mt-40 xl:mr-12">
                    ...
                    <form className="max-w-md mx-auto">
                        ...
                        <div className="relative w-full max-w-xl mx-auto bg-white rounded-full">
                            <input placeholder="Graphic Designer..." className="rounded-full w-full h-16 bg-transparent py-2 pl-8 pr-32 outline-none border-2 border-gray-100 shadow-md hover:outline-none focus:ring-teal-200 focus:border-teal-200" type="text" name="query" id="query" />
