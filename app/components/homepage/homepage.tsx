...
const HomePageComponent: FC = () => {
    return (
        <div className="py-28 text-center md:pt-36 lg:text-left xl:pt-44 xl:pb-32 flex justify-center" style={{ "background": "linear-gradient(#f6f3f9, rgba(255, 255, 255, 1))" }}>
                ...
                <div className="mb-16 lg:mt-32 xl:mt-40 xl:mr-12">
                    ...
                    <form className="max-w-md mx-auto">
                        ...
                        <div className="relative w-full max-w-xl mx-auto bg-white rounded-full">
                            <input placeholder="Graphic Designer..." className="rounded-full w-full h-16 bg-transparent py-2 pl-8 pr-32 outline-none border-2 border-gray-100 shadow-md hover:outline-none focus:ring-[#664481] focus:border-[#664481]" type="text" name="query" id="query" />
                            <button type="submit" className="absolute inline-flex items-center h-10 px-4 py-2 text-sm text-white transition duration-150 ease-in-out rounded-full outline-none right-3 top-3 bg-[#664481] sm:px-6 sm:text-base sm:font-medium focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500">
                    ...
                    <div className="max-w-md mx-auto mt-16 flex justify-center items-center">
                        <button className="px-5 py-3 bg-[#664481] text-white rounded-lg">Get Started</button>
                    </div>
                </div>
