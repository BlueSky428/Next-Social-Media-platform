    ...
    return (
        <div className="w-full flex justify-center items-center bg-white">
            <div className="lg:flex-row md:flex-row sm:flex-row flex-col flex justify-center items-center py-8 gap-4">
                <div className="lg:w-[40%] md:[40%] sm:w-[40%] flex justify-center items-center">
                    <div className="lg:px-8 md:px-6 sm:px-4 px-4 h-full flex items-center justify-center">
                ...
                <div className="lg:w-[60%] md:w-[60%] md:w-[60%] flex justify-center items-center">
                    <div className="lg:px-8 md:px-6 sm:px-4 px-4 h-full flex items-center justify-center">
